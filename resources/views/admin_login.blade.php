...
<body>
<div class="log-w3"style="min-height: calc(100vh )" ><!-- full page -->
<div class="w3layouts-main">
	...
	?>
		<form action="{{URL::to('/admin_dashboard')}}" method="post">
			{{ csrf_field() }} <!-- lệnh sinh ra mã token  -->
			...
			<span><input type="checkbox" />Nhớ  đăng nhập  |Remember Me</span>
			<h6><a href="#">Quên mật khẩu | Forgot Password?</a></h6>
