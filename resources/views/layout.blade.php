                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{('public/home/images/girl1.jpg')}}" class="girl img-responsive" alt="" />
                                    <img src="{{('public/home/images/pricing.png')}}"  class="pricing" alt="" />
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{('public/home/images/girl2.jpg')}}" class="girl img-responsive" alt="" />
                                    <img src="{{('public/home/images/pricing.png')}}"  class="pricing" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{('public/home/images/girl3.jpg')}}" class="girl img-responsive" alt="" />
                                    <img src="{{('public/home/images/pricing.png')}}" class="pricing" alt="" />
                                </div>
                            </div>
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="shipping text-center"><!--shipping-->
                            <img src="{{('public/home/images/shipping.jpg')}}" alt="" />
                        </div><!--/shipping-->
                    ...
                    <div class="col-sm-7">
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{('public/home/images/iframe1.png')}}" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{('public/home/images/iframe2.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{('public/home/images/iframe3.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{('public/home/images/iframe4.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
