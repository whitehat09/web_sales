...
<div class="row">
    ...
    ?>
                            <div class="position-center">
                                ...
                                <form role="form" action="{{URL::to('/update_product/'.$pro->product_id)}}" method="post" enctype="multipart/form-data" > <!--  lấy hình ảnh trong from phải thêm enctype="multipart/form-data" -->
                                    {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none; " rows="8" class="form-control" name="product_content" id="exampleInputPassword1" placeholder="Mô tả sản phẩm">{{$pro->product_content}}</textarea>
                                </div>
                                <div class="form-group">
